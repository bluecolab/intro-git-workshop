...
(Recommened) VS Code: https://code.visualstudio.com/
...
For example if you have a "BlueCoLab_Projects" folder in uour "Documents" folder you would first enter:
```
...
Now you can start working on the project. If you installed VS Code, enter the following command to open the project. Replace <name of reoo> with neam of GitHub repo:
```
code <name of reoo> 
```
...
### Development
At Blue CoLab, we work in a collaboritive enviorement. Here are suggestions on how to use Git and GitHub to help us:
